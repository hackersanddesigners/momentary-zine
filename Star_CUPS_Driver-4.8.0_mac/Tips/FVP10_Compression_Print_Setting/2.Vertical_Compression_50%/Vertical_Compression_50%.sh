...
# 2) Copy this script (Vertical_Compression_50%.sh) and 
#    Vertical_Compression_50%.dat into home folder.
# 3) Execute Termnal which is in the "Accessories" of "Applications",
#    then input "./Vertical_Compression_50%.sh" and return Enter key.
# 4) After execution, printer will print self test.
#    Please verify print result of <8> line in "-- Memory Switch --" part.
#    8rd digit of the <8> line should be set to "1".
#
#    Sample: 
#        <8> 0000000100000000 0100
#
lpr -o raw Vertical_Compression_50%.dat
#
#
# Note:
...
#
#    Example
#       star-no-power-mac-g4:~ star$ lpr -o raw Vertical_Compression_50%.dat -P TSP651__STR_T_001_
#
