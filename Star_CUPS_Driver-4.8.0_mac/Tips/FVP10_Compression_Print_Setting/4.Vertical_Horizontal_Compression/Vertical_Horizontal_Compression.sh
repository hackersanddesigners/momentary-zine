...
# 2) Copy this script (Vertical_Horizontal_Compression.sh) and
#    Vertical_Horizontal_Compression.dat into home folder.
# 3) Execute Termnal which is in the "Accessories" of "Applications",
#    then input "./Vertical_Horizontal_Compression.sh" and return Enter key.
# 4) After execution, printer will print self test.
#    Please verify print result of <8> line in "-- Memory Switch --" part.
#    4rd and 8rd digit of the <8> line should be set to "1".
#
#    Sample: 
#        <8> 0001000100000000 1100
#
lpr -o raw Vertical_Horizontal_Compression.dat
#
#
# Note:
...
#
#    Example
#       star-no-power-mac-g4:~ star$ lpr -o raw Vertical_Horizontal_Compression.dat -P TSP651__STR_T_001_
#
