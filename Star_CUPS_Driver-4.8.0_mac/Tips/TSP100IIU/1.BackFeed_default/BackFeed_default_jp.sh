#!/bin/sh
#
# TSP100IIU用 Back Feed Default 設定スクリプト
#
# 利用方法:
#
# 1) TSP100IIUをデフォルトプリンタにしてください。
# 2) ホームフォルダに本スクリプト(BackFeed_default_jp.sh)とBackFeed_default.datをコピーしてください。
# 3) Finderから"Applications"-"Accessories"内のTerminalを起動し
#    "./BackFeed_default_jp.sh"と入力し、Enterキーを押してください。
#
