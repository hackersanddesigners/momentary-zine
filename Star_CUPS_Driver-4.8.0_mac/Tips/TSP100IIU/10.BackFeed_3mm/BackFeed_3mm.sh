#!/bin/sh
#
# Back Feed 3mm Setting Script for TSP100IIU
#
# How to use:
#
# 1) Set TSP100IIU a Default printer
# 2) Copy this script (BackFeed_3mm.sh) and BackFeed_3mm.dat into home folder.
# 3) Execute Termnal which is in the "Accessories" of "Applications",
#    then input "./BackFeed_3mm.sh" and return Enter key.
#
lpr -o raw BackFeed_3mm.dat
#
#
# Note:
...
#
#    $ lpr -o raw BackFeed_3mm.dat -P "Printer-queue name"
#
#    Example
#       star-no-power-mac-g4:~ star$ lpr -o raw BackFeed_3mm.dat -P TSP100IIU__STR_T_001_
#
