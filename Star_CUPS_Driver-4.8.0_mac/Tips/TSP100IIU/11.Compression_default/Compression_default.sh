#!/bin/sh
#
# Compression Default Setting Script for TSP100IIU
#
# How to use:
#
# 1) Set TSP100IIU a Default printer
# 2) Copy this script (Compression_default.sh) and Compression_default.dat into home folder.
# 3) Execute Termnal which is in the "Accessories" of "Applications",
#    then input "./Compression_default.sh" and return Enter key.
#
lpr -o raw Compression_default.dat
#
#
# Note:
...
#
#    $ lpr -o raw Compression_default.dat -P "Printer-queue name"
#
#    Example
#       star-no-power-mac-g4:~ star$ lpr -o raw Compression_default.dat -P TSP100IIU__STR_T_001_
#
