#!/bin/sh
#
# TSP100IIU用 Compression Default 設定スクリプト
#
# 利用方法:
#
# 1) TSP100IIUをデフォルトプリンタにしてください。
# 2) ホームフォルダに本スクリプト(Compression_default_jp.sh)とCompression_default.datをコピーしてください。
# 3) Finderから"Applications"-"Accessories"内のTerminalを起動し
#    "./Compression_default_jp.sh"と入力し、Enterキーを押してください。
#
